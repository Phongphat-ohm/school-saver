...
import { getCurrentWorkspaceAction, getMyWorkspacesAction } from "@/features/workspace/actions";
import { WorkspaceSwitcher } from "@/features/workspace/components/WorkspaceSwitcher";
import { Button } from "@/components/ui/Button";
import { Search, UserRound } from "lucide-react";
import { NotificationButton } from "@/features/notifications/components/NotificationButton";
import { getPendingWorkspaceInvitationsAction } from "@/features/workspace/actions";
    ...
    <header className="fixed inset-x-0 top-0 z-[80] px-4 py-4 backdrop-blur lg:left-64">
      <div className="flex items-center justify-between gap-3">
        <div className="min-w-0 lg:hidden">
          <p className="text-sm font-black text-blue-700 lg:hidden">SchoolSaver</p>
        ...
        <div className="flex items-center gap-2 rounded-[1.5rem] bg-white/80 p-1.5 shadow-sm">
